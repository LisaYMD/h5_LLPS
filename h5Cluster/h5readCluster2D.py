...
class h5readCluster2D( h5readCluster ): 
    def __init__(self, filename):
        ...
        aa_ampar = 3292 # DsRed # of residues (pseudo-ampar complex)
        self.size_list[self.types_str.index("A")] = size(aa_ampar)
        return None
...
#result = h5readCluster2D("v2p424.264phase200_5.h5")
#result.draw_snapshot(10000) 
